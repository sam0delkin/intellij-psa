        ...
        val innerPanel = panel {
            values.forEachIndexed { index, el ->
                row(index.toString()) {
                    ...
                    textField.component.document.addDocumentListener(object: DocumentListener {
                    ...
                    actionButton(object: DumbAwareAction("Remove Row", "", AllIcons.General.Remove) {
            ...
            row {
                actionButton(object: DumbAwareAction("Add Row", "", AllIcons.General.Add) {
                    override fun actionPerformed(e: AnActionEvent) {
                        val newValues = ArrayList<String>(values)
                        newValues.add("")
                        self.pcs.firePropertyChange("values", values, newValues)
